...
Elm.SeatSaver.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Toggle") {
            var updateSeat = function (model) {
               return _U.eq(model.seatNo,_p0._0.seatNo) ? _U.update(model,{occupied: $Basics.not(model.occupied)}) : model;
            };
   ...
   var fetchSeats = $Effects.task(A2($Task.map,SetSeats,$Task.toMaybe(A2($Http.get,decodeSets,"http://localhost:4000/api/seats"))));
