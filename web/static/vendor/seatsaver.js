...
Elm.SeatSaver.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      var updateSeat = function (model) {    return _U.eq(_p0._0.seatNo,model.seatNo) ? _U.update(model,{occupied: $Basics.not(model.occupied)}) : model;};
   ...
   var seatItem = F2(function (address,seat) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("seat available"),A2($Html$Events.onClick,address,Toggle(seat))]),
